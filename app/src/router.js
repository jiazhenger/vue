...
const routes = [
	...
	{ path: '/communication',			component: resolve => { require.ensure([], () => resolve(require('@views/component/communication/communication')), 		'component')} },
	{ path: '/parent-children',			component: resolve => { require.ensure([], () => resolve(require('@views/component/communication/parent-children')), 	'component')} },
	{ path: '/ref',						component: resolve => { require.ensure([], () => resolve(require('@views/component/communication/ref')), 				'component')} },
	{ path: '/provide-inject',			component: resolve => { require.ensure([], () => resolve(require('@views/component/communication/provide-inject')), 	'component')} },
